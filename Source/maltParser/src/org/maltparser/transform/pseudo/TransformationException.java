...
/**
 * TransformationException extends the MaltChainedException class and is thrown
 * by classes within the transform package.
 *
 * @author Johan Hall
 * @since 1.0
*
...
public class TransformationException extends MaltChainedException {
    ...
    /**
     * Creates a TransformationException object with a message and a cause to
     * the exception.
     *
     * @param message	the message

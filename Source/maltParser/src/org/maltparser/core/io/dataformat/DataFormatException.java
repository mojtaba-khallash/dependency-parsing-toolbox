...
/**
 * DataFormatException extends the MaltChainedException class and is thrown by
 * classes within the dataformat package.
 *
 * @author Johan Hall
 * @since 1.0
*
...
public class DataFormatException extends MaltChainedException {
    ...
    /**
     * Creates a DataFormatException object with a message and a cause to the
     * exception.
     *
     * @param message	the message

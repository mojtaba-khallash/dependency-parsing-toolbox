...
/**
 * DataFormatEntry is used for storing information about one column in a data
 * format.
 *
 * @author Johan Hall
 * @since 1.0
...
public class DataFormatEntry {
    ...
    /**
     * Column category (INPUT, HEAD, DEPENDENCY_EDGE_LABEL,
     * PHRASE_STRUCTURE_EDGE_LABEL, PHRASE_STRUCTURE_NODE_LABEL,
     * SECONDARY_EDGE_LABEL, IGNORE and INTERNAL)
     */

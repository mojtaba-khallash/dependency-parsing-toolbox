...
public class MaltChainedException extends Exception {
    ...
    /**
     * Creates a MaltChainedException instance with a message and keeps track of
    ...
    /*
     * (non-Javadoc) @see java.lang.Throwable#getCause()
     */
    @Override
    ...
    /**
     * Returns a string representation of the exception chain. Only MaltParser
     * specific exception is included.
     *
    ...
    /*
     * (non-Javadoc) @see java.lang.Throwable#printStackTrace()
     */
    @Override

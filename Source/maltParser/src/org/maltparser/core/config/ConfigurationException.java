...
/**
 * ConfigurationException extends the MaltChainedException class and is thrown
 * by classes within the configuration package.
 *
 * @author Johan Hall
*
 */
public class ConfigurationException extends MaltChainedException {
    ...
    /**
     * Creates a ConfigurationException object with a message and a cause to the
     * exception.
     *
     * @param message	the message

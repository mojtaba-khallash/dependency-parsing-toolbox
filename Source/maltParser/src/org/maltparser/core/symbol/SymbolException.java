...
/**
 * SymbolException extends the MaltChainedException class and is thrown by
 * classes within the symbol package.
 *
 * @author Johan Hall
 * @since 1.0
*
...
public class SymbolException extends MaltChainedException {
    ...
    /**
     * Creates a SymbolException object with a message and a cause to the
     * exception.
     *
     * @param message	the message

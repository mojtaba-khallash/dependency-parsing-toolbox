...
public abstract class NullValues {
    ...
    public boolean equals(Object obj) {
        ...
        if (!nullValueStrategy.equalsIgnoreCase(nl.getNullValueStrategy())) {
            return false;
        }
        if (nextCode != nl.getNextCode()) {
            return false;
        }
    ...
    public String toString() {
        ...
        sb.append("  Strategy: ").append(nullValueStrategy);
        sb.append("  NO_NODE -> ").append(nullValue2CodeMap.get(NullValueId.NO_NODE)).append(" ").append(nullValue2SymbolMap.get(NullValueId.NO_NODE)).append("\n");

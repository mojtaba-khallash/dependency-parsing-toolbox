...
/**
 * FeatureException extends the MaltChainedException class and is thrown by
 * classes within the feature package.
 *
 * @author Johan Hall
*
 */
public class FeatureException extends MaltChainedException {
    ...
    /**
     * Creates a FeatureException object with a message and a cause to the
     * exception.
     *
     * @param message	the message

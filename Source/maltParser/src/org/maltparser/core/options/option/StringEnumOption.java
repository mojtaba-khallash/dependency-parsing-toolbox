...
/**
 * A string enum type option is an option that can only contain string value
 * that corresponds to another string.
 *
 * @author Johan Hall
 * @since 1.0
*
...
public class StringEnumOption extends Option {
    ...
    /*
     * (non-Javadoc) @see
     * org.maltparser.core.options.option.Option#getDefaultValueObject()
     */
    ...
    /*
     * (non-Javadoc) @see
     * org.maltparser.core.options.option.Option#setDefaultValue(java.lang.String)
     */
    ...
    /*
     * (non-Javadoc) @see
     * org.maltparser.core.options.option.Option#getDefaultValueString()
     */
    ...
    /**
     * Returns the mapped legal value that corresponds to the enumerate string
     * value.
     *
     * @param value	an enumerate string value
     * @return the mapped legal value that corresponds to the enumerate string
     * value.
     */
    ...
    /*
     * (non-Javadoc) @see
     * org.maltparser.core.options.option.Option#getStringRepresentation(java.lang.Object)
     */
    ...
    /*
     * (non-Javadoc) @see org.maltparser.core.options.option.Option#toString()
     */
    @Override

...
/**
 * Abstract class that contains description of an option that are the same over
 * all option types.
 *
 * @author Johan Hall
 * @since 1.0
...
public abstract class Option implements Comparable<Option> {
    ...
    /**
     * The option is saved during learning and cannot be overloaded during
     * processing (parsing)
     */
    ...
    /**
     * Returns the corresponding object for the option value (specified as a
     * string value).
     *
     * @param value	the string option value
     * @return the corresponding object for the option value (specified as a
     * string value).
     * @throws OptionException
     */
     ...
     * @return a string representation of the option value, if the option value
    ...
    /**
     * Returns true if the option name is ambiguous over all option groups,
     * otherwise false.
     *
     * @return	true if the option name is ambiguous over all option groups,
     * otherwise false.
     */
    ...
    /**
     * Sets true if the option name is ambiguous over all option groups,
     * otherwise false.
     *
     * @param ambiguous	true if the option name is ambiguous over all option

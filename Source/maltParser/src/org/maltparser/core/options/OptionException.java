...
/**
 * OptionException extends the MaltChainedException class and is thrown by
 * classes within the options package.
 *
 * @author Johan Hall
 * @since 1.0
*
...
public class OptionException extends MaltChainedException {
    ...
    /**
     * Creates an OptionException object with a message and a cause to the
     * exception.
     *
     * @param message	the message

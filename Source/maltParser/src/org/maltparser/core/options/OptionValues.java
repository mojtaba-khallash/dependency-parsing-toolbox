...
/**
 * OptionValues contain a number of option containers, which contains the option
 * values (the instance of options).
 *
 * @author Johan Hall
 * @since 1.0
*
...
//		optionContainers = new TreeMap<Integer, OptionContainer>();
    ...
    /**
     * Returns the option value for an option that is in a specific option
     * container.
     *
     ...
     * in a specific option container.
     *
     * @param containerIndex	the index of the option container.
     * @param option	an option object
     * @return a string representation of the option value for an option that is
     * in a specific option container.
     * @throws OptionException
     */
     ...
     *
     * @param option	an option object
     * @return	the option value for an option, <i>null</i> if the option value
     * could not be found.
     * @throws OptionException
     */
    ...
    public String toString() {
        ...
        if (optionContainers.size() == 0) {
            ...
            for (Integer index : optionContainers.keySet()) {
                sb.append("Option container : ").append(index).append("\n");
                sb.append(optionContainers.get(index)).append("\n");
            }
        }
        return sb.toString();
    }

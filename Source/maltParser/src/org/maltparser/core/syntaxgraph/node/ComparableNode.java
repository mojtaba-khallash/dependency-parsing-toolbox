...
public interface ComparableNode extends Element, Comparable<ComparableNode> {
    ...
    /**
     * Returns the right-most proper terminal descendant node (excluding
     * itself).
     *
    ...
    /**
     * Returns the index of the left-most proper terminal descendant node
     * (excluding itself).
     *
    ...
    /**
     * Returns the index of the right-most proper terminal descendant node
     * (excluding itself).
     *
    ...
    /**
     * Returns the in degree of the node (number of incoming edges of all types
     * of edges).
     *
     * @return the in degree of the node (number of incoming edges of all types
     * of edges).
     */
    public int getInDegree();

    /**
     * Returns the out degree of the node (number of outgoing edges of all types
     * of edges).
     *
     * @return the out degree of the node (number of outgoing edges of all types
     * of edges).
     */

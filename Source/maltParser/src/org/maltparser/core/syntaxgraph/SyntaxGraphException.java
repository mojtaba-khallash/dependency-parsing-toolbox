...
/**
 * GraphException extends the MaltChainedException class and is thrown by
 * classes within the graph package.
 *
 * @author Johan Hall
*
 */
public class SyntaxGraphException extends MaltChainedException {
    ...
    /**
     * Creates a GraphException object with a message and a cause to the
     * exception.
     *
     * @param message	the message

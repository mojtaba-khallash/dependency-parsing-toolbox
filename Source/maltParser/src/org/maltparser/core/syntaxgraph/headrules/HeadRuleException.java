...
/**
 * HeadRuleException extends the MaltChainedException class and is thrown by
 * classes within the headrule package.
 *
 * @author Johan Hall
*
 */
public class HeadRuleException extends MaltChainedException {
    ...
    /**
     * Creates a HeadRuleException object with a message and a cause to the
     * exception.
     *
     * @param message	the message

...
public interface Element {
    ...
    /**
     * Adds a label (a string value) to the symbol table and to the graph
     * element.
     *
    ...
    /**
     * Adds a label (an integer value) to the symbol table and to the graph
     * element.
     *
     * @param table the symbol table
    ...
    /**
     * Returns <i>true</i> if the graph element has a label for the symbol
     * table, otherwise <i>false</i>.
     *
     * @param table the symbol table
     * @return <i>true</i> if the graph element has a label for the symbol
     * table, otherwise <i>false</i>.
     * @throws MaltChainedException
     */
    ...
    /**
     * Returns the label symbol(a string representation) of the symbol table if
     * it exists, otherwise an exception is thrown.
     *
     * @param table the symbol table
     * @return the label (a string representation) of the symbol table if it
     * exists.
     * @throws MaltChainedException
     */
    ...
    /**
     * Returns the label code (an integer representation) of the symbol table if
     * it exists, otherwise an exception is thrown.
     *
     * @param table the symbol table
     * @return the label code (an integer representation) of the symbol table if
     * it exists
     * @throws MaltChainedException
     */
    ...
    /**
     * Returns <i>true</i> if the graph element has one or more labels,
     * otherwise <i>false</i>.
     *
     * @return <i>true</i> if the graph element has one or more labels,
     * otherwise <i>false</i>.
     */
    ...
    /**
     * Returns a set of symbol tables (labeling functions or label types) that
     * labels the graph element.
     *

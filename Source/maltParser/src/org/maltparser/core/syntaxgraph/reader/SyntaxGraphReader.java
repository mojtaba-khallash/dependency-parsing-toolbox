...
public interface SyntaxGraphReader {
    ...
    /**
     * Cause the syntax graph reader to read the beginning of the file (such as
     * header information)
     *
     * @throws MaltChainedException
     */
    ...
    /**
     * Reads a sentence (token structure, dependency structure or/and phrase
     * structure)
     *
     ...
     *
     * @param optionString a string representation of the reader specific
     * options
     * @throws MaltChainedException
     */

...
/**
 * The jar class loader loads the content of a jar file that complies with a
 * MaltParser Plugin.
 *
 * @author Johan Hall
 */
public class JarLoader extends SecureClassLoader {
    ...
    /*
     * (non-Javadoc) @see java.lang.ClassLoader#findClass(java.lang.String)
     */
    @Override
    ...
    public boolean readJarFile(URL jarUrl) throws MaltChainedException {
        ...
        /*
         * if (logger.isDebugEnabled()) { logger.debug("Loading jar " +
         * jarUrl+"\n");
		}
         */
        JarFile jarFile;

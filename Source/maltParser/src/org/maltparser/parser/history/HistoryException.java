...
/**
 * HistoryException extends the MaltChainedException class and is thrown by
 * classes within the history package.
 *
 * @author Johan Hall
 * @since 1.1
*
...
public class HistoryException extends MaltChainedException {
    ...
    /**
     * Creates a HistoryException object with a message and a cause to the
     * exception.
     *
     * @param message	the message

...
public abstract class ParserConfiguration {
    ...
    /**
     * Returns true if the parser configuration is in a terminal state,
     * otherwise false.
     *
     * @return true if the parser configuration is in a terminal state,
     * otherwise false.
     * @throws MaltChainedException
     */
    ...
    /**
     * Initialize the parser configuration with the same state as the parameter
     * config
     *

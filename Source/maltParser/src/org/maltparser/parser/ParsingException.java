...
/**
 * ParsingException extends the MaltChainedException class and is thrown by
 * classes within the parser.algorithm package.
 *
 * @author Johan Hall
*
 */
public class ParsingException extends MaltChainedException {
    ...
    /**
     * Creates a ParsingException object with a message and a cause to the
     * exception.
     *
     * @param message	the message

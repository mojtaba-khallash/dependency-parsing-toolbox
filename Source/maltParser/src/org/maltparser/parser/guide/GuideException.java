...
/**
 * GuideException extends the MaltChainedException class and is thrown by
 * classes within the guide package.
 *
 * @author Johan Hall
 * @since 1.0
*
...
public class GuideException extends MaltChainedException {
    ...
    /**
     * Creates a GuideException object with a message and a cause to the
     * exception.
     *
     * @param message	the message

...
public class AtomicModel implements InstanceModel {
     ...
     *
     * @param index the index of the atomic model (-1..n), where -1 is special
     * value (used by a single model or the master divide model) and n is number
     * of divide models.
...
//			}
    ...
    /**
     * Moves all instance from this atomic model into the destination atomic
     * model and add the divide feature. This method is used by the feature
     * divide model to sum up all model below a certain threshold.
     *

...
/**
 * LiblinearException extends the MaltChainedException class and is thrown by
 * classes within the libsvm package.
 *
 * @author Johan Hall
 * @since 1.0
*
...
public class LiblinearException extends MaltChainedException {
    ...
    /**
     * Creates a LiblinearException object with a message and a cause to the
     * exception.
     *
     * @param message	the message

...
public final class Edges {
    ...
    public static void put(int pos1, int pos2, boolean dir, short label) {
        putD(pos1, pos2, dir, label);
        //	putD(pos2, pos1,!dir, label);		
    }

    public static void putD(int pos1, int pos2, boolean dir, short label) {
...
//			edgesh[pos1][pos2][dir?0:1].add(label);
    ...
    public static short[] get(int pos1, int pos2, boolean dir) {

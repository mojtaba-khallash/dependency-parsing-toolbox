...
//			significant(options.significant1, options.significant2) ;
    ...
    private static void check(String s1, String s2, String pos) {
        ...
        HashMap<String, HashMap<String, Integer>> labchanged = new HashMap<>();
        ...
        while (s1i != null) {
            ...
            if (good != 0 || wrong != 0) {
                Parser.out.println(snt + " changed yes:" + good + " no:" + wrong);
            }
            s1i = s1reader.getNext();
            s2i = s2reader.getNext();
        }
        Parser.out.println("" + labchanged);
    }
    ...
    public static Results evaluate(String act_file, String pred_file, boolean printEval, boolean sig) {
        ...
        HashMap<String, HashMap<String, Integer>> confusion = new HashMap<>();

        HashMap<String, HashMap<String, Integer>> posLabelAssign = new HashMap<>();
        ...
        while (goldInstance != null) {
            ...
            for (int i = 1; i < instanceLength; i++) {
                ...
                if (goldLabels[i].equals(predLabels[i]) && (what == TAGGER || predHeads[i] == goldHeads[i])) {
                    ...
                    if (conf == null) {
                        confusion.put(goldLabels[i], conf = new HashMap<>());
                    }
        ...
        for (Entry<String, HashMap<String, Integer>> e : confusion.entrySet()) {
            ...
            ArrayList<Entry<String, Integer>> entries = new ArrayList<>(values.entrySet());
            ...
            Parser.out.println(e.getKey() + "\t" + entries);
        }
        Parser.out.println("" + posLabelAssign);

 ...
 */
public class DeprojectivizePanel extends BasePanel {
    ...
    /**
     * Creates new form DeprojectivizePanel
     */
    public DeprojectivizePanel(String dir) {
        super(dir);
        ...
        txtInputFile.setText(dir + File.separator + 
                             ...
                             "projective_head_head_shortest.conll");
        txtModelFile.setText(dir + File.separator + 
                             "Treebank" + File.separator + 
                             "non-projective" + File.separator + 
                             "projective_head_head_shortest.mco");
        txtOutputPath.setText(dir + File.separator + 
                              "Output" + File.separator +
                              "deprojectivize" + File.separator);
    ...
    public void save() {
        switch (tabDependencyInfo.getSelectedIndex()) {
            case 0:
                ...
                saveText(filter, "Deprojectivizing_log.txt", txtLog.getText());
                break;
            case 1:
                // Tree
                saveTree(1);
    ...
    private void initComponents() {
        ...
        btnBrowseModelFile = new javax.swing.JButton();
        btnReadNext = new javax.swing.JButton();
        ...
        pnlDeprojectivizeDT = new javax.swing.JPanel();
        ...
        addHierarchyBoundsListener(new java.awt.event.HierarchyBoundsListener() {
            ...
            public void ancestorResized(java.awt.event.HierarchyEvent evt) {
                DeprojectivizePanel_Resized(evt);
            }
        });
        ...
        txtModelFile.setEditable(false);

        btnBrowseModelFile.setText("...");
        btnBrowseModelFile.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnBrowseModelFile_Click(evt);
            }
        });

        btnReadNext.setText("Start");
        btnReadNext.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnReadNext_Click(evt);
            }
        });
        ...
        pnlParameterLayout.setVerticalGroup(
            ...
            .addGroup(pnlParameterLayout.createSequentialGroup()
                ...
                .addGroup(pnlParameterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnBrowseModelFile))
        ...
        jLabel1.setText("Deprojectivizing");
        ...
        jLabel3.setText("Deprojectivize Tree");
        jLabel3.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);

        pnlDeprojectivizeDT.setBackground(new java.awt.Color(255, 255, 255));

        javax.swing.GroupLayout pnlDeprojectivizeDTLayout = new javax.swing.GroupLayout(pnlDeprojectivizeDT);
        pnlDeprojectivizeDT.setLayout(pnlDeprojectivizeDTLayout);
        pnlDeprojectivizeDTLayout.setHorizontalGroup(
            pnlDeprojectivizeDTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 0, Short.MAX_VALUE)
        );
        pnlDeprojectivizeDTLayout.setVerticalGroup(
            pnlDeprojectivizeDTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 94, Short.MAX_VALUE)
        );
        ...
        pnlRightLayout.setHorizontalGroup(
            ...
            .addComponent(pnlDeprojectivizeDT, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private void makeFormReady() {
        ...
        pnlDeprojectivizeDT.removeAll();
        pnlDeprojectivizeDT.revalidate();
    ...
    File dest_from;
    File dest_to;
    private void btnReadNext_Click(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReadNext_Click
        gui = null;
        makeFormReady();
        ...
        try {
            if (isInit == false) {
                ...
                to = new File(wd + File.separator + input);
                inputFile = to.getAbsolutePath();

                String modelFile = txtModelFile.getText();
                // Ensure have an absolute path
                File model_from = new File(modelFile).getAbsoluteFile();
                String modelName = model_from.getName();
                File model_to = new File(wd + File.separator + modelName);
                ...
                DeprojectivizeCorpus.out = out;

                // Run in a new thread
                Runnable job = new RunnableProjectivize(this, TransformType.Deprojectivize, wd, input, output, modelName, null, null, null);
    ...
    }//GEN-LAST:event_btnReadNext_Click
    ...
    private void DeprojectivizePanel_Resized(java.awt.event.HierarchyEvent evt) {//GEN-FIRST:event_DeprojectivizePanel_Resized
        AdjustDividerLocation();
        ChangeViewMode();
    }//GEN-LAST:event_DeprojectivizePanel_Resized

    private void btnBrowseModelFile_Click(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBrowseModelFile_Click
        FileNameExtensionFilter filter = new FileNameExtensionFilter(
            "Malt Configuration File", "mco");
        txtModelFile.setText(showFileDialog(txtModelFile.getText(), false, filter));
    }//GEN-LAST:event_btnBrowseModelFile_Click
    ...
    private void UpdateTree(int index) throws MaltChainedException {
        ...
        pnl = tv.getSplitPane();
        pnlDeprojectivizeDT.removeAll();
        pnlDeprojectivizeDT.setLayout(new GridLayout());
        pnlDeprojectivizeDT.add(pnl);
        pnlDeprojectivizeDT.revalidate();
    ...
    private javax.swing.JButton btnBrowseModelFile;
    ...
    private javax.swing.JButton btnReadNext;
    ...
    private javax.swing.JPanel pnlDeprojectivizeDT;
